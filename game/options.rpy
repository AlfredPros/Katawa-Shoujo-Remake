...
define config.enter_transition = ImageDissolve(im.Tile("tr-dots_col.png"), 0.75)
define config.exit_transition = ImageDissolve(im.Tile("tr-dots_col.png"), 0.75, reverse=True)
